...
class PipelineConfig:
    ...
    DOCUMENTS_INDEX_BASE = os.getenv('DOCUMENTS_INDEX', 'documents')
    CHUNKS_INDEX_BASE = os.getenv('CHUNKS_INDEX', 'chunks')
    ...
    CATEGORY_KEYWORDS = {
        ...
        'technical': [
            'api', 'code', 'function', 'class', 'method', 'technical',
            'implementation', 'specification', 'architecture'
        ],
        'educational': [
            'tutorial', 'guide', 'how-to', 'learning', 'course', 'lesson'
        ],
        'qa': [
            'question', 'answer', 'ask', 'solve', 'problem', 'solution'
        ],
        'blog': [
            'blog', 'article', 'post', 'opinion', 'insights', 'thoughts'
        ]
    }
